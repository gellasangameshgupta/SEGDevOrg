({
    ...
    handleApprovalEvent: function(component, event, helper) {
        ...
        var workFlowName = component.get("v.buttons.workflow");
        console.log('WF Name: ', workFlowName);
        ...
        if(buttonLabel === "Reassign" && workFlowName === 'New Vendor Creation') {
            component.set("v.showLookupVMCmp", true);
        } else if(buttonLabel === "Reassign" || buttonLabel === "Consult") {
            component.set("v.showLookupCmp", true);
        } else {
            component.set("v.showLookupCmp", false);
            component.set("v.showLookupVMCmp", false);
        }
    },
